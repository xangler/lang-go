...
func (c *healthServiceClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/learngo.web.common.core.HealthService/HealthCheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HealthService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/learngo.web.common.core.HealthService/HealthCheck",
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "learngo.web.common.core.HealthService",
	...
	Metadata: "github.com/learn-go/web/common/pb/core/service.proto",
}
